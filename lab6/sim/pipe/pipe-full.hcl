...
# 1. Adding implement for IIADDQ instruction
# 2. Adding forwarding from Memory to Execute, replace e_valA with 
#    forwarding register value to avoid bubble in load/use hazard.
...
bool F_stall =
	...
	!(d_srcA == E_dstM && d_srcB != E_dstM && D_icode in { IRMMOVQ, IPUSHQ }) ||
